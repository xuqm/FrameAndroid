...
package com.xuqm.base.common.xlog;
...
import com.xuqm.base.common.xlog.interceptor.Interceptor;
import com.xuqm.base.common.xlog.internal.DefaultsFactory;
import com.xuqm.base.common.xlog.internal.SystemCompat;
import com.xuqm.base.common.xlog.internal.util.StackTraceUtil;
import com.xuqm.base.common.xlog.printer.Printer;
import com.xuqm.base.common.xlog.printer.PrinterSet;
 ...
 * <p>
 * A {@link Logger} is always generated and mostly accessed by {@link com.xuqm.base.common.xlog.XLog}, but for customization
 * purpose, you can configure a {@link Logger} via the {@link Builder} which is returned by
 * {@link com.xuqm.base.common.xlog.XLog} when you trying to start a customization using {@link com.xuqm.base.common.xlog.XLog#tag(String)}
 ...
 * the {@link Logger} assuming that you are using the {@link com.xuqm.base.common.xlog.XLog} directly.
 */
public class Logger {
   ...
   */
    ...
    LogConfiguration.Builder logConfigBuilder = new LogConfiguration.Builder(
        com.xuqm.base.common.xlog.XLog.sLogConfiguration);
    ...
    if (builder.printer != null) {
      ...
      printer = com.xuqm.base.common.xlog.XLog.sPrinter;
    }
  }
  ...
  public static class Builder {
     ...
     * it can be a package name like "com.xuqm.base.common.xlog", a class name like "com.yourdomain.logWrapper",
     ...
     *                         "com.xuqm.base.common.xlog", a class name like "com.yourdomain.logWrapper",
     *                         or something else between package name and class name, like "com.yourdomain.".
     *                         It is mostly used when you are using a logger wrapper
     * @param depth            the number of stack trace elements we should log, 0 if no limitation
     * @return the builder
