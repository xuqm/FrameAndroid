...
import static com.xuqm.base.common.xlog.XLog.assertInitialization;
...
public class LogUtils {
  ...
  public static String formatJson(String json) {
    ...
    return com.xuqm.base.common.xlog.XLog.sLogConfiguration.jsonFormatter.format(json);
  }
  ...
  public static String formatXml(String xml) {
    assertInitialization();
    return com.xuqm.base.common.xlog.XLog.sLogConfiguration.xmlFormatter.format(xml);
  }
  ...
  public static String formatThrowable(Throwable throwable) {
    assertInitialization();
    return com.xuqm.base.common.xlog.XLog.sLogConfiguration.throwableFormatter.format(throwable);
  }
  ...
  public static String formatThread(Thread thread) {
    assertInitialization();
    return com.xuqm.base.common.xlog.XLog.sLogConfiguration.threadFormatter.format(thread);
  }
  ...
  public static String formatStackTrace(StackTraceElement[] stackTrace) {
    assertInitialization();
    return com.xuqm.base.common.xlog.XLog.sLogConfiguration.stackTraceFormatter.format(stackTrace);
  }
